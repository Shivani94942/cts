...
public class Tester {
	...
	public static void main(String[] args) {
		  ...
		  try { System.out.println(args[1]); System.out.println(30/0); } catch
		...
		/*
		 * Tester tester=new Tester(); try { tester.calculate(args[0]); } catch
		 * (Exception e) { System.err.println(e.toString()); e.printStackTrace(); }
		 */
